      ...
      <div className="justify-content-center flex flex-col items-center">
        <div className="w-9/12 ">
          <div className="flex justify-center gap-10">
            <button
              className={`${!isPrevWeekAvailable ? "text-gray-400" : ""}`}
            ...
            <button
              className={`${!isNextWeekAvailable ? "text-gray-400" : ""}`}
                      ...
                      <button
                        ...
                        className={`transition-colors duration-150 ${
                          !reservedVisitDate
                            ...
                            : isFetching
                            ? "bg-loading"
                            : selectedDate.date === reservationDate?.date &&
                              selectedDate.from === reservationDate?.from &&
                              selectedDate.to === reservationDate?.to
        ...
        <div className="mt-10 ">
          {!reservationDate ? (
            <p className="text-red-500">Nie wybrano zadnej daty!</p>
          ) : (
            <p>
              Wybrano {reservationDate.date} od {reservationDate.from} do{" "}
              {reservationDate.to}
            </p>
          )}
        </div>
